...
import com.android.pantiasuhan.pantiasuhan.donatur.Menu_Awal_donatur;
...
public class MenuActivity extends AppCompatActivity
   ...
   /* @Override
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_surat_permohonan) {
            startActivity(new Intent(MenuActivity.this, TampilSemuaPanti.class));
        } else if (id == R.id.nav_bantuan) {
            startActivity(new Intent(MenuActivity.this, TampilBantuan.class));
        ...
        {startActivity(new Intent(MenuActivity.this, AllMapsActivity.class));
            ...
            startActivity(new Intent(MenuActivity.this, Menu_Awal_donatur.class));
        }
