...
public class TampilSemuaPanti extends AppCompatActivity implements ListView.OnItemClickListener{
    ...
    private void deleteEmployee(final String str){
        class DeleteEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TampilSemuaPanti.this, "Updating...", "Tunggu...", false, false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(TampilSemuaPanti.this, s, Toast.LENGTH_LONG).show();
                startActivity(new Intent(getApplicationContext(),TampilSemuaPanti.class));
            }
    ...
    private void showEmployee(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                TampilSemuaPanti.this, list, R.layout.list_item_data_panti_admin,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TampilSemuaPanti.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
       ...
       Intent intent = new Intent(this, MenuAdmin.class);
        ...
        SharedPreferences sharedPreferences = TampilSemuaPanti.this.getSharedPreferences(konfigurasi.SHARED_PREF_NAME, Context.MODE_PRIVATE);
