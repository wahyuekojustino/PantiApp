...
public class DetailDataDonatur extends AppCompatActivity implements View.OnClickListener{
    ...
    private EditText editTextNamaDonatur;
    private EditText editTextPekerjaan;
    private EditText editTextAlamatDonatur;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_donatur_admin);
        ...
        editTextId = (EditText) findViewById(R.id.etIdDonatur);
        editTextNamaDonatur = (EditText) findViewById(R.id.etDonatur);
        editTextPekerjaan = (EditText) findViewById(R.id.etPekerjaan);
        editTextAlamatDonatur = (EditText) findViewById(R.id.etAlamatDonatur);
       ...
       // Toast.makeText(this, id_tentor, Toast.LENGTH_SHORT).show();
        ...
        editTextNamaDonatur.setEnabled(false);
        editTextPekerjaan.setEnabled(false);
        editTextAlamatDonatur.setEnabled(false);
    ...
    private void getData(String id_donatur) {
        String url = konfigurasi.URL_GET_EMP_DONATUR;
        StringRequest stringRequest = new StringRequest(url+id_donatur,
    ...
    private void HasilAmbil(JSONArray result) {
        ...
        editTextId.setText(id_donatur);
            editTextNamaDonatur.setText(NamaDonatur);
            editTextPekerjaan.setText(Pekerjaan);
            editTextAlamatDonatur.setText(AlamatDonatur);
...
/*
    private void updateEmployee(){
        final String nama_donatur = editTextNamaDonatur.getText().toString().trim();
        final String pekerjaan = editTextPekerjaan.getText().toString().trim();
        final String alamat_donatur = editTextAlamatDonatur.getText().toString().trim();
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(konfigurasi.KEY_EMP_ID,id_donatur);
        ...
        editTextId.setText("");
        editTextNamaDonatur.setText("");
        editTextPekerjaan.setText("");
        editTextAlamatDonatur.setText("");
        editTextTlp.setText("");
    }
*/
private void validasiEmployee(){
    class ValidasiEmployee extends AsyncTask<Void,Void,String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loading = ProgressDialog.show(DetailDataDonatur.this, "Updating...", "Tunggu...", false, false);
        }
        ...
        protected String doInBackground(Void... params) {
            RequestHandler rh = new RequestHandler();
            String s = rh.sendGetRequestParam(konfigurasi.URL_VALIDASI_EMP_DONATUR, id_donatur);
            return s;
        }
    }
