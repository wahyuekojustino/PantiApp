...
public class DetailDataPantiAll extends AppCompatActivity {
     ...
     EditText etUsername;
     EditText etPassword, etTotal, etJmlLaki, etJmlPerempuan;
    EditText etRekening;
    EditText etSK;
   ...
   TextView lat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_panti_all);
